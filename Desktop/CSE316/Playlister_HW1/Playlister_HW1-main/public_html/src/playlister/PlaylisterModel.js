...
export default class PlaylisterModel {
    ...
    */
    ...
    addNewSong() {
        ...
        this.currentList.songs[this.currentList.songs.length] = newSong;
        this.view.refreshPlaylist(this.currentList);
        this.saveLists();
    }

    confirmEdit(i, song){
        this.currentList.songs[i] = song;
        this.view.refreshPlaylist(this.currentList);
        this.saveLists();
    }
    ...
    //DELETE A SONG
    deleteSong(initID){
        this.currentList.songs.splice(initID, 1);
        this.view.refreshPlaylist(this.currentList);
        this.saveLists();
    }
    ...
    addSongAt(i, song) {
        this.currentList.songs.splice(i, 0, song);
        this.view.refreshPlaylist(this.currentList);
        this.saveLists();
    }
    ...
    add_AddSongTransaction(songObject){
        let transaction = new AddSong_Transaction(this, songObject);
        this.tps.addTransaction(transaction);
        this.view.updateToolbarButtons(this);
    }

    addEditSongTransaction(initId, newSong, oldSong){
        let transaction = new EditSong_Transaction(this, initId, newSong, oldSong);
        this.tps.addTransaction(transaction);
        this.view.updateToolbarButtons(this);
    }

    addRemoveSongTransaction(initId, song) {
        let transaction = new RemoveSong_Transaction(this, initId, song);
        this.tps.addTransaction(transaction);
        this.view.updateToolbarButtons(this);
    }
}